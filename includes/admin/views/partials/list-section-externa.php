...
<h2 style="color:#555;border-bottom:1px solid #ccc;padding-bottom:5px;">
	<?php esc_html_e( 'Atividades Externas', 'tutor-ead' ); ?>
</h2>

<a href="<?php echo esc_url( admin_url( 'admin.php?page=tutor-ead-add-atividade-externa' ) ); ?>"
   class="button"
   style="background:#555;color:#fff;padding:10px 15px;border:none;border-radius:4px;text-decoration:none;display:inline-block;margin-bottom:15px;">
	<?php esc_html_e( 'Criar Nova Atividade Externa', 'tutor-ead' ); ?>
</a>

<?php if ( $atividades_externas ) : ?>
	<table class="widefat fixed striped" style="width:100%;border-collapse:collapse;margin-bottom:20px;">
		<thead style="background:#ddd;">
			<tr>
				...
				<th style="padding:8px;border:1px solid #ccc;"><?php esc_html_e( 'Link Externo', 'tutor-ead' ); ?></th>
		...
		<tbody>
			<?php foreach ( $atividades_externas as $a ) : ?>
				<tr>
					...
					<td style="padding:8px;border:1px solid #ccc;"><?php echo esc_html( $a->link_externo ); ?></td>
					...
					<td style="padding:8px;border:1px solid #ccc;">
						...
						<a href="<?php echo esc_url( admin_url( 'admin.php?page=tutor-ead-edit-atividade-externa&atividade_id=' . $a->id ) ); ?>"><?php esc_html_e( 'Editar', 'tutor-ead' ); ?></a> | 
...
<?php else : ?>
	<p style="color:#777;"><?php esc_html_e( 'Nenhuma atividade externa encontrada.', 'tutor-ead' ); ?></p>
<?php endif; ?>
