...
/* $atividade (opcional) */
?>
<h2 style="color:#555;margin-bottom:10px;"><?php esc_html_e( 'Informações da Atividade Externa', 'tutor-ead' ); ?></h2>
...
<table class="form-table" style="width:100%;">
	...
	<tr>
		<th style="text-align:left;padding:8px;"><?php esc_html_e( 'Link Externo', 'tutor-ead' ); ?></th>
		<td style="padding:8px;"><input type="url" name="link_externo" required
			   value="<?php echo isset( $atividade ) ? esc_attr( $atividade->link_externo ) : ''; ?>"
			   style="width:100%;padding:10px;border:1px solid #ccc;border-radius:4px;"></td>
	</tr>
